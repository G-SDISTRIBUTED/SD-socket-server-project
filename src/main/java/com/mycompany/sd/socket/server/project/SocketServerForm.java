 ...
 * @author Pc
 */
public class SocketServerForm extends javax.swing.JFrame {
    private TCPSocketServer tcpSocketServer;
    /**
     * Creates new form SocketServerForm
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SocketServerForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SocketServerForm().setVisible(true);
            }
        });
    }
